...
import {GraphDisplay, GraphDisplayStyle, Margin} from '../types/api'
import {drawCanvasLine} from './drawUtil'
...
export const drawFigure = (fg: PIXI.Graphics, bg: PIXI.Graphics, dims: WindowDimensions, graphDisplay: GraphDisplay) => {
    ...
    drawXAxis(fg, dims, graphDisplay.displayProperties.style)
    drawYAxis(fg, dims, graphDisplay.displayProperties.style)
